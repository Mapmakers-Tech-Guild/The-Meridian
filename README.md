...
- **Live site (GitHub Pages):** [mapmakers-tech-guild.github.io/Mapmakers-Knowledgebase](https://mapmakers-tech-guild.github.io/Mapmakers-Knowledgebase/) — built by [`pages.yml`](.github/workflows/pages.yml) on each push to `main` *when Pages is available for the repo.* **Private repo + free org/account:** [GitHub Pages is not available for private repositories on GitHub Free](https://docs.github.com/en/pages/getting-started-with-github-pages/about-github-pages#who-can-use-this-feature) — the deploy step fails with **404** / “Not Found” (no deployment API). **Options:** use **Pro/Team/Enterprise** for this org, make the repo **public** (Pages works on Free for public repos), or host the static output elsewhere (e.g. Cloudflare Pages, Netlify, S3). *If you have Pages:* [set source to **GitHub Actions**](https://docs.github.com/en/pages/getting-started-with-github-pages/configuring-a-publishing-source-for-your-github-pages-site#publishing-with-a-custom-github-actions-workflow) under **Settings → Pages** (one-time). *Note:* the **published site URL is public** even when the repo is private on a paid plan; do not publish secrets in the built files. To **avoid red failed runs** while the repo is private on Free, turn off the workflow in **Actions → “Deploy Pages (interactive map)” → … → Disable workflow** (or delete `pages.yml`).  
